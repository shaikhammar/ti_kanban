...
export default function Create() {
    // console.log(usePage<PageProps>().props.permissions);
    const permissions = usePage<rolesPageProps>().props.permissions.data;
    // console.log(permissions);
    const { data, setData, post, processing, errors } = useForm<Role>({
        id: 0,
        name: "",
        permissions: [],
